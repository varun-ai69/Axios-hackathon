// src/components/Employee/EmployeeChatbot.jsx
...
const EmployeeChatbot = () => {
  const [messages, setMessages] = useState([
    { id: 1, text: 'Hello! I can help you with information from company documents. What would you like to know?', sender: 'bot' }
  ]);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        {/* Header */}
        <div className="bg-purple-600/20 border-b border-white/10 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-300 text-xs">Ask questions about company documents</p>
            </div>
          </div>
        </div>
